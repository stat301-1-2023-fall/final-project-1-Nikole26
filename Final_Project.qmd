...
```
Through this latitude vs longitude plot, it is appreciated that most restaurants are located in France. This reinforces the univariate analysis that showed France having the highest amount of restaurants in the dataset. 
